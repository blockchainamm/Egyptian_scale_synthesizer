# Program to generate the sounds of notes of an Egyptian scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a Egyptian scale
    notes_interval = [2, 3, 2, 3, 2, 2] #2 - 3 - 2 - 3 - 2
    rev_interval = [0, 2, 3, 2, 3, 2]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of ascending notes for {notescale} as root note in the Egyptian scale')
    ...
    print()
    print(f'The frequencies in Hz of descending notes for {notescale} as root note in the Egyptian scale')
    ...
    # Return list of frequencies in the ascending and descending notes of the Egyptian scale    
...
# Scale list for which the Egyptian scale will be played in sequence
scale_list = ['C4']
