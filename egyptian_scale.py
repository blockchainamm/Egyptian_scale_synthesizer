...
def load_notes(notestep, notestep1, notescale):
    ...
    print(f'The frequencies in Hz of ascending notes for {notescale} in the Egyptian scale')
    ...
    print()
    print(f'The frequencies in Hz of descending notes for {notescale} in the Egyptian scale')
